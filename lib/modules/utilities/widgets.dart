...
class MapleTooltip extends StatelessWidget {
  ...
  const MapleTooltip(
      ...
      : assert((label == null) != (child == null),
            'Either `label` or `child` must be specified');
      ...
      richMessage: WidgetSpan(
        ...
        child: Container(
            ...
            constraints: BoxConstraints(
                maxWidth: maxWidth != null ? (maxWidth! + 8) : 400.0,
                maxHeight: 470),
            child: SingleChildScrollView(
              padding:
                  const EdgeInsets.only(right: 8, left: 5, top: 5, bottom: 5),
              child: Column(
                  children: tooltipTitle.isNotEmpty
                      ? <Widget>[
                            Text(tooltipTitle,
                                style:
