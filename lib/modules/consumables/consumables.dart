...
class Consumable {
  ...
  static Consumable loadFromJson(
      String consumableId, Map<String, dynamic> jsonData) {
    String name = jsonData["name"];
    String description = jsonData["description"];
    Map<StatType, num> consumableStats =
        loadJsonStatMap(jsonData["consumableStats"]);
  ...
  Image getAssetImage() {
    return Image(
        image: AssetImage('assets/images/consumables/$consumableId.png'),
        height: 40,
