...
enum ScrollName {
  ...
  masteriaGrandmasterScroll(
      formattedName:
          "Masteria Grandmaster Accessory Exclusive Enhancement Scroll",
      scrollType: StaticScroll,
      scrollStats: {
  ...
  accessoryStr100(formattedName: "STR 100%", scrollType: Scroll, scrollStats: [
    {StatType.str: 1},
    {StatType.str: 1},
    {StatType.str: 2},
  ]),
  accessoryStr70(formattedName: "STR 70%", scrollType: Scroll, scrollStats: [
    {StatType.str: 2},
    {StatType.str: 2},
    {StatType.str: 3},
  ]),
  accessoryStr30(formattedName: "STR 30%", scrollType: Scroll, scrollStats: [
    {StatType.str: 3},
    {StatType.str: 4},
    {StatType.str: 5},
  ]),
  accessoryDex100(formattedName: "DEX 100%", scrollType: Scroll, scrollStats: [
    {StatType.dex: 1},
    {StatType.dex: 1},
    {StatType.dex: 2},
  ]),
  accessoryDex70(formattedName: "DEX 70%", scrollType: Scroll, scrollStats: [
    {StatType.dex: 2},
    {StatType.dex: 2},
    {StatType.dex: 3},
  ]),
  accessoryDex30(formattedName: "DEX 30%", scrollType: Scroll, scrollStats: [
    {StatType.dex: 3},
    {StatType.dex: 4},
    {StatType.dex: 5},
  ]),
  accessoryInt100(formattedName: "INT 100%", scrollType: Scroll, scrollStats: [
    {StatType.int: 1},
    {StatType.int: 1},
    {StatType.int: 2},
  ]),
  accessoryInt70(formattedName: "INT 70%", scrollType: Scroll, scrollStats: [
    {StatType.int: 2},
    {StatType.int: 2},
    {StatType.int: 3},
  ]),
  accessoryInt30(formattedName: "INT 30%", scrollType: Scroll, scrollStats: [
    {StatType.int: 3},
    {StatType.int: 4},
    {StatType.int: 5},
  ]),
  accessoryLuk100(formattedName: "LUK 100%", scrollType: Scroll, scrollStats: [
    {StatType.luk: 1},
    {StatType.luk: 1},
    {StatType.luk: 2},
  ]),
  accessoryLuk70(formattedName: "LUK 70%", scrollType: Scroll, scrollStats: [
    {StatType.luk: 2},
    {StatType.luk: 2},
    {StatType.luk: 3},
  ]),
  accessoryLuk30(formattedName: "LUK 30%", scrollType: Scroll, scrollStats: [
    {StatType.luk: 3},
    {StatType.luk: 4},
    {StatType.luk: 5},
  ]),
  ...
  accessoryHP100(formattedName: "HP 100%", scrollType: Scroll, scrollStats: [
    {StatType.hp: 50},
    {StatType.hp: 50},
    {StatType.hp: 100},
  ]),
  accessoryHP70(formattedName: "HP 70%", scrollType: Scroll, scrollStats: [
    {StatType.hp: 100},
    {StatType.hp: 100},
    {StatType.hp: 150},
  ]),
  accessoryHP30(formattedName: "HP 30%", scrollType: Scroll, scrollStats: [
    {StatType.hp: 150},
    {StatType.hp: 200},
    {StatType.hp: 250},
  ]),
  ...
  AbstractScroll createScrollObject() {
    if (scrollType == ScrollWithRange) {
      return ScrollWithRange(
          scrollName: this, scrollStats: scrollStats, slotCost: slotCost);
...
class SavedScroll extends AbstractScroll implements Copyable {
  ...
  Widget createScrollContainer(BuildContext context, int? itemLevel) {
    return scrollName
        .createScrollObject()
        .createScrollContainer(context, itemLevel);
  }
}
