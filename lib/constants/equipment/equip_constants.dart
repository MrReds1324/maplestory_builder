...
enum EquipName {
  ...
  superiorGolluxRing(
      formattedName: "Superior Gollux Ring",
      equipType: EquipType.ring,
      flameCategory: FlameCategory.none,
      maxScrollsSlots: 8,
      isUniqueItem: true,
      itemLevel: 150,
      baseStats: {
  ...
  superiorGolluxPendant(
      formattedName: "Superior Gollux Pendant",
      equipType: EquipType.pendant,
      flameCategory: FlameCategory.nonAdvantaged,
      maxScrollsSlots: 8,
      itemLevel: 150,
      baseStats: {
        StatType.allStats: 28,
        StatType.hp: 300,
        StatType.mp: 300,
        StatType.attack: 5,
        StatType.mattack: 5,
  ...
  superiorGolluxBelt(
      formattedName: "Superior Gollux Belt",
  ...
  superiorGolluxEarrings(
      formattedName: "Superior Gollux Earrings",
  ...
  dawnGuardianAngelRing(
      formattedName: "Dawn Guardian Angel Ring",
      equipType: EquipType.ring,
      flameCategory: FlameCategory.none,
      maxScrollsSlots: 4,
      isUniqueItem: true,
  ...
  estellaEarrings(
      formattedName: "Estella Earrings",
      equipType: EquipType.earrings,
      maxScrollsSlots: 5,
      itemLevel: 160,
      baseStats: {
  ...
  daybreakPendant(
      formattedName: "Daybreak Pendant",
      equipType: EquipType.pendant,
      maxScrollsSlots: 7,
      isUniqueItem: true,
      itemLevel: 140,
  ...
  eternalArcherHat(
      formattedName: "Eternal Archer Hat",
      ...
      baseStats: {
        ...
        StatType.dex: 80,
        StatType.attack: 10,
        StatType.defense: 750,
        StatType.ignoreDefense: 0.15
      }),
  eternalArcherHood(
      formattedName: "Eternal Archer Hood",
      ...
      baseStats: {
        ...
        StatType.dex: 50,
        StatType.attack: 6,
        StatType.defense: 325,
        StatType.ignoreDefense: 0.05
      }),
  eternalArcherPants(
      formattedName: "Eternal Archer Pants",
  ...
  eternalArcherShoulder(
      formattedName: "Eternal Archer Shoulder",
      ...
      itemLevel: 250,
      baseStats: {
        StatType.allStats: 51,
        StatType.attack: 28,
        StatType.mattack: 28,
        StatType.defense: 450
      }),
  // Genesis Weapons
  genesisCrossbow(
      formattedName: "Genesis Crossbow",
      equipType: EquipType.weapon,
      classType: ClassType.bowman,
      isLuckyItem: true,
      itemLevel: 200,
      starForceCategory: StarForceCategory.static,
      baseStats: {
        StatType.attackSpeed: ATTACK_SPEED_FAST_6,
        StatType.str: 150,
        StatType.dex: 150,
        StatType.attack: 326,
        StatType.speed: 19,
  ...
  arcaneUmbraArcherHat(
      formattedName: "Arcane Umbra Archer Hat",
      equipType: EquipType.hat,
      classType: ClassType.bowman,
      maxScrollsSlots: 13,
      itemLevel: 200,
  ...
  arcaneUmbraArcherSuit(
      formattedName: "Arcane Umbra Archer Suit",
      ...
      baseStats: {
        ...
        StatType.dex: 85,
        StatType.attack: 9,
        StatType.defense: 500,
        StatType.ignoreDefense: 0.1
      }),
  arcaneUmbraArcherShoes(
      formattedName: "Arcane Umbra Archer Shoes",
  ...
  arcaneUmbraArcherGloves(
      formattedName: "Arcane Umbra Archer Gloves",
  ...
  arcaneUmbraArcherCape(
      formattedName: "Arcane Umbra Archer Cape",
      equipType: EquipType.cape,
      classType: ClassType.bowman,
      maxScrollsSlots: 9,
      itemLevel: 200,
      baseStats: {
        StatType.allStats: 35,
        StatType.attack: 6,
        StatType.mattack: 6,
        StatType.defense: 450
      }),
  arcaneUmbraArcherShoulder(
      formattedName: "Arcane Umbra Archer Shoulder",
      equipType: EquipType.shoulder,
      classType: ClassType.bowman,
      flameCategory: FlameCategory.none,
      maxScrollsSlots: 3,
  ...
  // Arcane Weapons
  arcaneUmbraCrossbow(
      formattedName: "Arcane Umbra Archer Crossbow",
      equipType: EquipType.weapon,
      classType: ClassType.bowman,
      maxScrollsSlots: 10,
      itemLevel: 200,
  ...
  blackHeart(
      formattedName: "Black Heart",
      equipType: EquipType.heart,
      itemLevel: 120,
      flameCategory: FlameCategory.none,
      potentialCategory: PotentialCategory.static,
      baseStats: {
        StatType.allStats: 10,
        StatType.hp: 100,
        StatType.attack: 77,
  ...
  sourceOfSuffering(
      formattedName: "Source of Suffering",
      equipType: EquipType.pendant,
      itemLevel: 160,
      maxScrollsSlots: 7,
      baseStats: {
  ...
  cursedRedSpellbook(
      formattedName: "Cursed Red Spellbook",
      equipType: EquipType.pocket,
      itemLevel: 160,
      starForceCategory: StarForceCategory.none,
      potentialCategory: PotentialCategory.none,
      baseStats: {
        StatType.allStats: 10,
        StatType.str: 10,
        StatType.attack: 10,
  ...
  cursedGreenSpellbook(
      formattedName: "Cursed Green Spellbook",
      equipType: EquipType.pocket,
      itemLevel: 160,
      starForceCategory: StarForceCategory.none,
      potentialCategory: PotentialCategory.none,
  ...
  cursedBlueSpellbook(
      formattedName: "Cursed Blue Spellbook",
      equipType: EquipType.pocket,
      itemLevel: 160,
      starForceCategory: StarForceCategory.none,
      potentialCategory: PotentialCategory.none,
  ...
  cursedYellowSpellbook(
      formattedName: "Cursed Yellow Spellbook",
      equipType: EquipType.pocket,
      itemLevel: 160,
      starForceCategory: StarForceCategory.none,
      potentialCategory: PotentialCategory.none,
  ...
  commandingForceEarring(
      formattedName: "Commanding Force Earrings",
      equipType: EquipType.earrings,
      itemLevel: 200,
      maxScrollsSlots: 8,
      baseStats: {
  ...
  mitrasRageWarrior(
      formattedName: "Mitra's Rage: Warrior",
      equipType: EquipType.emblem,
      classType: ClassType.warrior,
      itemLevel: 200,
      starForceCategory: StarForceCategory.none,
      potentialCategory: PotentialCategory.player,
      flameCategory: FlameCategory.none,
      baseStats: {
        StatType.str: 40,
        StatType.dex: 40,
  ...
  mitrasRageBowman(
      formattedName: "Mitra's Rage: Bowman",
      equipType: EquipType.emblem,
      classType: ClassType.bowman,
      itemLevel: 200,
      starForceCategory: StarForceCategory.none,
  ...
  mitrasRagePirate(
      formattedName: "Mitra's Rage: Pirate",
      equipType: EquipType.emblem,
  ...
  mitrasRageMagician(
      formattedName: "Mitra's Rage: Magician",
      equipType: EquipType.emblem,
  ...
  mitrasRageThief(
      formattedName: "Mitra's Rage: Thief",
      equipType: EquipType.emblem,
