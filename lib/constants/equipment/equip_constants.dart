...
enum EquipName {
  ...
  cursedRedSpellbook(formattedName: "Cursed Red Spellbook", equipType: EquipType.pocket, itemLevel: 160, potentialCategory: PotentialCategory.none, baseStats: {StatType.allStats: 10, StatType.str: 10, StatType.attack: 10, StatType.mattack: 10, StatType.hp: 100, StatType.mp: 100}),
  cursedGreenSpellbook(formattedName: "Cursed Green Spellbook", equipType: EquipType.pocket, itemLevel: 160, potentialCategory: PotentialCategory.none, baseStats: {StatType.allStats: 10, StatType.dex: 10, StatType.attack: 10, StatType.mattack: 10, StatType.hp: 100, StatType.mp: 100}),
  cursedBlueSpellbook(formattedName: "Cursed Blue Spellbook", equipType: EquipType.pocket, itemLevel: 160, potentialCategory: PotentialCategory.none, baseStats: {StatType.allStats: 10, StatType.int: 10, StatType.attack: 10, StatType.mattack: 10, StatType.hp: 100, StatType.mp: 100}),
  cursedYellowSpellbook(formattedName: "Cursed Yellow Spellbook", equipType: EquipType.pocket, itemLevel: 160, potentialCategory: PotentialCategory.none, baseStats: {StatType.allStats: 10, StatType.luk: 10, StatType.attack: 10, StatType.mattack: 10, StatType.hp: 100, StatType.mp: 100}),
  ...
  genesisBadge(formattedName: "Genesis Badge", equipType: EquipType.badge, itemLevel: 200, potentialCategory: PotentialCategory.none, flameCategory: FlameCategory.none, baseStats: {StatType.allStats: 15, StatType.attack: 10, StatType.mattack: 10, StatType.speed: 10, StatType.jump: 10}),
  mitrasRageWarrior(formattedName: "Mitra's Rage: Warrior", equipType: EquipType.emblem, classType: ClassType.warrior, itemLevel: 200, potentialCategory: PotentialCategory.none, flameCategory: FlameCategory.none, baseStats: {StatType.str: 40, StatType.dex: 40, StatType.attack: 5, StatType.mattack: 5, StatType.hp: 700}),
  mitrasRageBowman(formattedName: "Mitra's Rage: Bowman", equipType: EquipType.emblem, classType: ClassType.bowman, itemLevel: 200, potentialCategory: PotentialCategory.none, flameCategory: FlameCategory.none, baseStats: {StatType.str: 40, StatType.dex: 40, StatType.attack: 5, StatType.mattack: 5}),
  mitrasRagePirate(formattedName: "Mitra's Rage: Pirate", equipType: EquipType.emblem, classType: ClassType.pirate, itemLevel: 200, potentialCategory: PotentialCategory.none, flameCategory: FlameCategory.none, baseStats: {StatType.str: 40, StatType.dex: 40, StatType.attack: 5, StatType.mattack: 5}),
  mitrasRageMagician(formattedName: "Mitra's Rage: Magician", equipType: EquipType.emblem, classType: ClassType.magician, itemLevel: 200, potentialCategory: PotentialCategory.none, flameCategory: FlameCategory.none, baseStats: {StatType.int: 40, StatType.luk: 40, StatType.attack: 5, StatType.mattack: 5}),
  mitrasRageThief(formattedName: "Mitra's Rage: Thief", equipType: EquipType.emblem, classType: ClassType.thief, itemLevel: 200, potentialCategory: PotentialCategory.none, flameCategory: FlameCategory.none, baseStats: {StatType.dex: 40, StatType.luk: 40, StatType.attack: 5, StatType.mattack: 5}),
;
