...
enum EquipName {
  ...
  // Genesis Weapons
  genesisCrossbow(formattedName: "Genesis Crossbow", equipType: EquipType.weapon, classType: ClassType.bowman, isLuckyItem: true, itemLevel: 200, starForceCategory: StarForceCategory.static, baseStats: {StatType.attackSpeed: ATTACK_SPEED_FAST_6, StatType.str: 150, StatType.dex: 150, StatType.attack: 326, StatType.speed: 19, StatType.bossDamage: 0.3, StatType.ignoreDefense: 0.2}),
  ...
  // Arcane Weapons
  arcaneUmbraCrossbow(formattedName: "Arcane Umbra Archer Crossbow", equipType: EquipType.weapon, classType: ClassType.bowman, maxScrollsSlots: 10, itemLevel: 200, baseStats: {StatType.attackSpeed: ATTACK_SPEED_FAST_6, StatType.str: 100, StatType.dex: 100, StatType.attack: 283, StatType.speed: 19, StatType.bossDamage: 0.3, StatType.ignoreDefense: 0.2}),
  ...
  mitrasRageWarrior(formattedName: "Mitra's Rage: Warrior", equipType: EquipType.emblem, classType: ClassType.warrior, itemLevel: 200, starForceCategory: StarForceCategory.none, potentialCategory: PotentialCategory.player, flameCategory: FlameCategory.none, baseStats: {StatType.str: 40, StatType.dex: 40, StatType.attack: 5, StatType.mattack: 5, StatType.hp: 700}),
  mitrasRageBowman(formattedName: "Mitra's Rage: Bowman", equipType: EquipType.emblem, classType: ClassType.bowman, itemLevel: 200, starForceCategory: StarForceCategory.none, potentialCategory: PotentialCategory.player, flameCategory: FlameCategory.none, baseStats: {StatType.str: 40, StatType.dex: 40, StatType.attack: 5, StatType.mattack: 5}),
  mitrasRagePirate(formattedName: "Mitra's Rage: Pirate", equipType: EquipType.emblem, classType: ClassType.pirate, itemLevel: 200, starForceCategory: StarForceCategory.none, potentialCategory: PotentialCategory.player, flameCategory: FlameCategory.none, baseStats: {StatType.str: 40, StatType.dex: 40, StatType.attack: 5, StatType.mattack: 5}),
  mitrasRageMagician(formattedName: "Mitra's Rage: Magician", equipType: EquipType.emblem, classType: ClassType.magician, itemLevel: 200, starForceCategory: StarForceCategory.none, potentialCategory: PotentialCategory.player, flameCategory: FlameCategory.none, baseStats: {StatType.int: 40, StatType.luk: 40, StatType.attack: 5, StatType.mattack: 5}),
  mitrasRageThief(formattedName: "Mitra's Rage: Thief", equipType: EquipType.emblem, classType: ClassType.thief, itemLevel: 200, starForceCategory: StarForceCategory.none, potentialCategory: PotentialCategory.player, flameCategory: FlameCategory.none, baseStats: {StatType.dex: 40, StatType.luk: 40, StatType.attack: 5, StatType.mattack: 5}),
;
