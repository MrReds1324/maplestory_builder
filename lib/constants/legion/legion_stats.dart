...
enum LegionBlock {
  ...
  aran(formattedName: "Aran", legionEffect: (
    StatType.hp,
    [0, 0, 0, 0, 0]
  ) // 70% chance to recover 2/4/6/8/10% hp
      ),
  ark(
      formattedName: "Ark",
      legionEffect: (StatType.finalStr, [10, 20, 40, 80, 100])),
  ...
  dualBlade(
      ...
      legionEffect: (StatType.finalLuk, [10, 20, 40, 80, 100])),
  evan(formattedName: "Evan", legionEffect: (
    StatType.mp,
    [0, 0, 0, 0, 0]
  ) // 70% chance to recover 2/4/6/8/10% mp
      ),
  firePoisonMage(
  ...
  mercedes(formattedName: "Mercedes", legionEffect: (
  ...
  abyssalExpeditionMF(
    formattedName: "Abyssal Expedition (Minar Forest)",
    legionEffect: (StatType.attackMattack, [7, 14, 21, 28, 35]),
  ),
  ;
  ...
  static const List<String> LEGION_BLOCK_RANKS = [
    "F",
    "B",
    "A",
    "S",
  ...
  static const Set<LegionBlock> SPECIAL_BLOCKS = {
    LegionBlock.labServer,
    LegionBlock.enhancedLabServer,
    LegionBlock.abyssalExpeditionMF
  };
}
